...
import './properties-panel.html'; //import our template
...
Template.propertiespanel.onCreated(function onCreated() {
    //nothing to do here yet
    
});

Template.propertiespanel.onRendered(function onRendered() {
...
Template.propertiespanel.helpers({
    getModeler(){
        return modeler;
    }
});

Template.propertiespanel.events({
